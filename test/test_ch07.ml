let ex71 () =
  ...
  Alcotest.(check @@ pair int @@ float 0.01)
    "goukei_to_heikin 10 20 30 40 50" (150, 30.00)
  @@ goukei_to_heikin 10 20 30 40 50

let ex72 () =
  let open Prog_kiso_lib.Ch07 in
  Alcotest.(check string) "seiseki わど Good" "わどさんの評価はGoodです"
  @@ seiseki ("わど", "Good")

let ex73 () =
  let open Prog_kiso_lib.Ch07 in
  Alcotest.(check @@ pair int int) "taisho_x (10, 20)" (-10, 20)
  @@ taisho_x (10, 20)
