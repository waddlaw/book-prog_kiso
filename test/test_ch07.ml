let ex71 () =
  ...
  Alcotest.(check @@ pair int @@ float 0.01) "goukei_to_heikin 10 20 30 40 50" (150, 30.00) @@ goukei_to_heikin 10 20 30 40 50
...
let ex74() =
  let open Prog_kiso_lib.Ch07 in
  Alcotest.(check @@ pair int int) "chuten (10, 10) (20, 20)" (20, 20) @@ chuten (10, 10) (30, 30)
